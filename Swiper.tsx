...
import { SwiperPropsDefaultProps } from "./Swiper.props";
...
const calculateCardIndexes = (firstCardIndex, cards) => {
  ...
  console.log("calculateCardIndexes", {
    cards,
    firstCardIndex,
    secondCardIndex,
    previousCardIndex,
...
class Swiper extends Component {
  ...
  shouldComponentUpdate = (nextProps, nextState) => {
    ...
    console.log("shouldComponentUpdate", propsChanged, stateChanged);

    return propsChanged || stateChanged;
  };

  static getDerivedStateFromProps(nextProps, prevState) {
    if (!isEqual(nextProps.cards, prevState.cards)) {
      console.log("getDerivedStateFromProps", nextProps.cards);
